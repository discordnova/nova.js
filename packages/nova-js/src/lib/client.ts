  ...
  constructor(options: {
    ...
    const self = new Proxy(this, {
      get(self, symbol: string) {
        ...
        if (
          self.api[symbol as keyof typeof self.api] &&
          !self[symbol as keyof typeof self.api]
        ) {
          return self.api[symbol as keyof typeof self.api];
        }

        return self[symbol as keyof typeof self];
      },
    });
